...
export declare type AlphaLocale =
    ...
    | 'uk-UA'
    | 'vi-VN';
export declare type AlphanumericLocale =
    | 'ar'
    | 'ar-AE'
    | 'ar-BH'
    | 'ar-DZ'
    ...
    | 'uk-UA'
    | 'vi-VN';
export declare type MobilePhoneLocale =
    | 'any'
    | 'am-AM'
    | 'ar-AE'
    | 'ar-BH'
    ...
    | 'zh-HK'
    | 'zh-TW';
export declare type PostalCodeLocale =
    | 'any'
    | 'AD'
    | 'AT'
    | 'AU'
...
export declare type HashAlgorithm =
    ...
    | 'crc32'
    | 'crc32b';
export declare type IdentityCardLocale =
    | 'any'
    | 'ar-LY'
    | 'ar-TN'
    | 'ES'
    ...
    | 'zh-CN'
    | 'zh-TW';
export declare type PassportCountryCode =
    | 'AM'
    | 'AR'
    | 'AT'
    | 'AU'
...
export declare type TaxIDLocale =
    | 'bg-BG'
    | 'cs-CZ'
    | 'de-AT'
    | 'de-DE'
